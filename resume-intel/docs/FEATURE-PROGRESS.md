...
Canonical checklist for Resume Intel features. Updated by the auto-build agent
or manually via:

```bash
npm run mark-done -- --feature 9.1
```

**Status values:** `MISSING` | `PARTIAL` | `DONE`
...
| 3.2 | Google Search Fallback | DONE | yes | yes |
...
| 10.1 | Packaging & Installer | DONE | yes | yes |
